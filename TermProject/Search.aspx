...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyPlaceHolder" runat="server">
            ...
            <div class="col">
                ...
                <div class="row justify-content-start align-items-center">
                    <div class="d-inline pl-3">
                        <asp:TextBox runat="server" ID="txtMinAge" TextMode="Number" CssClass="form-control" min="18" MaxLength="110" Columns="3">18</asp:TextBox></div>
                    <div class="d-inline px-3"><span style="font-size: 2em; font-weight: bold">-</span></div>
                    <div class="d-inline">
                        <asp:TextBox runat="server" TextMode="Number" ID="txtMaxAge" CssClass="form-control" min="18" max="110" Columns="3">24</asp:TextBox></div>
                </div>
    ...
    <div id="divNoneFound" visible="false" runat="server">
        <div class="row justify-content-center w-75 mx-auto my-4">
            <h3>Sorry, no profiles found! Please try again!</h3>
        </div>
    </div>
